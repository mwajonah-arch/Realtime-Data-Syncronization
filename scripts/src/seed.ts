import { db, productsTable, transactionsTable, settingsTable } from "@workspace/db";
...
async function seed() {
  ...
  // Seed admin password
  await db.insert(settingsTable).values({ key: "adminPassword", value: "admin1234" }).onConflictDoNothing();
